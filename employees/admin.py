...
admin.site.register(CompensateLeaveApplication)
...
admin.site.register(EmployeeLeaveReport)
admin.site.register(LeaveReportTypeMembership)
admin.site.register(LeavePolicyTypeMembership)
admin.site.register(Schedule)
admin.site.register(DaysList)
