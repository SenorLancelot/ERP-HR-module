...
urlpatterns = [
    ...
    path("employees/list/", EmployeeViewSet.as_view({'get' : 'get_employee_list', "post" : 'post_to_employee_list', "delete" : 'delete_employees', "patch" : 'patch_employees_list'})),
    ...
    path("employeecheckins/checkout/post/", EmployeeCheckinsViewSet.as_view({"post" : "post_employee_checkout"})),
    path("monthlyreports/employee/<uuid:emp_id>", MonthlyReportsViewSet.as_view({"post" : "generate_monthly_report"}))
