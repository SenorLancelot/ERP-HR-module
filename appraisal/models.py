...
class AppraisalTemplate(models.Model):
    ...
    fk_goal = models.ManyToManyField(
        'Goal'
    )
...
class Appraisal(models.Model):
    ...
    fk_appraiser = models.ForeignKey(
        'employees.Employee', on_delete=models.SET_NULL, null=True, related_name='appraiser'
    )
    fk_employee = models.ForeignKey(
        'employees.Employee', on_delete=models.SET_NULL, null=True
    )
...
class AppraisalGoalMembership(models.Model):
    fk_appraisal = models.ForeignKey(
        'Appraisal', on_delete=models.CASCADE
    )
    fk_goal = models.ForeignKey(
